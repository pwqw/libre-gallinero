...
def main():
    ...
    print(f"\n{YELLOW}⚠️  NOTA: Este setup NO incluye apps{NC}")
    print(f"   Las apps se instalan después vía deploy WiFi:\n")
    print(f"   python3 tools/deploy_wifi.py                 # Base + blink app (default)\n")
    print(f"   python3 tools/deploy_wifi.py gallinero      # Base + gallinero app\n")
    ...
    print(f"  4. Usa: python3 tools/deploy_wifi.py para subir app blink (default)\n")
